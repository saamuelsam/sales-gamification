...
ALTER TABLE users ADD COLUMN IF NOT EXISTS points NUMERIC(15,2) DEFAULT 0 CHECK (points >= 0);
ALTER TABLE users ADD COLUMN IF NOT EXISTS parent_id UUID NULL;
ALTER TABLE users ADD COLUMN IF NOT EXISTS path LTREE DEFAULT NULL;

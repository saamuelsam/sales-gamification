...
class EmailService {
    ...
    async sendWelcomeEmail(email, name, verificationToken) {
        const verificationUrl = `${env_1.ENV.FRONTEND_URL}/verify-email?token=${verificationToken}`;
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
    ...
    async sendSaleNotification(email, name, saleValue, points) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
        ...
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="text-align: center; margin-top: 30px;">
              <a href="${env_1.ENV.FRONTEND_URL}/dashboard" style="display: inline-block; padding: 15px 30px; background: #F9A60C; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;">Ver Dashboard</a>
            </p>
          </div>
          <div class="footer">
            <p>© 2025 Fortal Engenharia Solar - Sales Gamification</p>
    ...
    async sendCommissionNotification(email, name, commissionValue, month) {
        const html = `
      <!DOCTYPE html>
      <html>
      <head>
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="text-align: center; margin-top: 30px;">
              <a href="${env_1.ENV.FRONTEND_URL}/commissions" style="display: inline-block; padding: 15px 30px; background: #123450; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;">Ver Comissões</a>
            </p>
          </div>
          <div class="footer">
            <p>© 2025 Fortal Engenharia Solar - Sales Gamification</p>
    ...
    async sendLevelUpNotification(email, name, newLevel, benefits) {
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p style="text-align: center; margin-top: 30px;">
              <a href="${env_1.ENV.FRONTEND_URL}/benefits" style="display: inline-block; padding: 15px 30px; background: #FC6E22; color: white; text-decoration: none; border-radius: 5px; font-weight: bold;">Ver Benefícios</a>
            </p>
          </div>
          <div class="footer">
            <p>© 2025 Fortal Engenharia Solar - Sales Gamification</p>

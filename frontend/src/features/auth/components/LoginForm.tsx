  ...
  return (
    <form onSubmit={handleSubmit} className="space-y-4">
      ...
      <div className="flex items-center justify-between text-sm">
        ...
        <a href="/forgot-password" className="text-primary hover:text-highlight font-medium hover:underline transition-colors">
          Esqueceu a senha?
        </a>
      </div>
      ...
      <button
        type="button"
        className="w-full flex items-center justify-center gap-3 px-4 py-3 border-2 border-gray-300 rounded-lg hover:border-primary hover:bg-primary/5 transition-all font-medium text-gray-700"
      >

...
import { User, LogOut, Bell, Check, Trash2, Loader2, X } from 'lucide-react';
    ...
    <nav className="bg-white border-b border-gray-200 px-3 sm:px-6 py-3 sm:py-4">
      <div className="flex items-center justify-between">
        ...
        <div className="min-w-0">
          <h2 className="text-lg sm:text-xl font-bold text-gray-900 truncate">Fortal Energia Solar</h2>
          <p className="text-xs sm:text-sm text-gray-600 truncate">Sistema de Gestão de Vendas</p>
        </div>
